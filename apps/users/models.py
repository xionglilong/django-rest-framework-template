...
from utils.app.models import GenericModelClass, GenericModel
...
class UserModel(AbstractUser, metaclass=GenericModelClass):
...
# 部门表
class DepartmentModel(MPTTModel, GenericModel):
...
# 短信验证码表
class SmsCodeModel(metaclass=GenericModelClass):
