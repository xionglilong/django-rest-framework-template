...
class ArticleModel(models.Model):
    title = models.CharField('文章标题', max_length=100, help_text="文章标题")
    content = models.TextField('文章内容')
    tags = models.ManyToManyField(to=ArticleTagModel, related_name="tags", null=True, blank=True, default=None)
    owner = models.ForeignKey(UserModel, related_name='article', on_delete=models.CASCADE, verbose_name='创建人', help_text="创建人")  # 把数据外键关联到一个所有者
    create_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
