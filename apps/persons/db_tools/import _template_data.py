...
person_data = [
    {'name': '张三', 'sex': 1, 'age': 23, 'mail': 'doicui@qq.com', 'icon': 'head/default.jpg', "owner": user1},
]

from apps.persons.models import PersonModel  # 先初始化环境，这里才能导入模块
...
for person_dict in person_data:
    ...
    person_instance.mail = person_dict['mail']
